...
NMilitary = {
	...
	ARMY_LOAD_MOVE_COST = 15.0,						-- Movement cost for moving armies onto fleets at sea.
	ARMY_UNLOAD_MOVE_COST = 15.0,					-- Movement cost for moving armies off fleets at sea.
